<template>
  <div class="row" style="padding: 2% 0 0 0; width: 100%; text-align: center;">
        ...
        <div id="chart_table">
          <form id="chart_datas">
            <div class="grid-container">
              ...
              <div class="addRowBtn" v-on:click.prevent="addRow" value=""><i class="fa fa-plus" aria-hidden="true"></i>
              </div>
            </div>
          </form>
          <!--<chart-table v-bind:proplabels="labels"></chart-table>-->
        </div>
      </div> <!-- end left panel -->
...
<script>
  ...
  export default {
    ...
    methods: {
      handleFileChange(e) {
        this.value_file = e.target.files[0]
      },
      addRow: function () {
        var newRow = {
          id: this.nextBarId++,
